...
def setFSLock (proxy_id, meta_id, shape_id = None):
	...
	lockdir = os.path.join (conf.baseproxypath, proxy_id)
	...
	if (lockfile.startswith(meta_id) for lockfile in locklist):
